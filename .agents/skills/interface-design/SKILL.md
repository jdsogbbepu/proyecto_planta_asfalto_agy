...
description: Esta habilidad es para el diseño de interfaces — paneles de control, aplicaciones, herramientas y productos interactivos. NO para diseño de marketing (páginas de aterrizaje, sitios promocionales, campañas).
---
